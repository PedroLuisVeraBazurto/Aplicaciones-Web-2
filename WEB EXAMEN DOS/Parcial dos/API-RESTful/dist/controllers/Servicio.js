...
exports.eliminarre = exports.actualizo = exports.obtener_id = exports.Obtener_servicio = exports.Obtener_productos = void 0;
...
const Obtener_productos = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ServicioNuevo = yield sala.save(); //a esa constante donde guardamos usamos la funcion save para almacenar en la base de datos
    if (!ServicioNuevo) {
...
const Obtener_servicio = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const Servico = yield models_1.Servicio.find(); //a esa constante donde guardamos usamos la funcion save para almacenar en la base de datos
    console.log(Servico);
    res.json(Servico);
});
exports.Obtener_servicio = Obtener_servicio;
const obtener_id = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    console.log(id);
    const actualizo = yield models_1.Servicio.findById({ _id: id }); //a esa constante donde guardamos usamos la funcion save para almacenar en la base de datos
    res.json(actualizo);
});
exports.obtener_id = obtener_id;
const actualizo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
